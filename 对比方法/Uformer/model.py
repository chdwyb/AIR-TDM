...
if __name__ == "__main__":
    ...
    myNet = Uformer(img_size=256,embed_dim=32,win_size=8,token_projection='linear',token_mlp='leff',
            depths=[1, 2, 8, 8, 2, 8, 8, 2, 1],modulator=True, dd_in=3).cuda()  # 实例化网络
    ...
    flops, params = profile(myNet, (x,))
    flops, params = clever_format([flops, params], "%.3f")
    print(flops, params)

    # from torchstat import stat
    # stat(myNet, (3, 512, 512))