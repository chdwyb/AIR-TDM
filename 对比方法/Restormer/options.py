...
class Options():
    def __init__(self):
        ...
        # self.Result_Path_Test = 'E://allweather_test/' + choice + '/result_Restormer/'

        self.Input_Path_Test = 'E://allweather_real_test/raindrop/input/'
        self.Result_Path_Test = 'E://allweather_real_test/raindrop/result_Restormer/'
